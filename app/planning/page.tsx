  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        console.log('schedulesRes.data:', schedulesRes.data);
        console.log('availabilityRes.data:', availabilityRes.data);
        
        // S'assurer que schedules est bien un tableau
                ...
                return (
                  <div key={date.toString()} className="flex flex-col gap-3">
                    <div className="text-center py-4 bg-cream/5 rounded-lg border border-cream/5">
                      <h3 className="font-serif text-xl font-bold tracking-wide capitalize">
